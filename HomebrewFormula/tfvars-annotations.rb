class TfvarsAnnotations < Formula
  ...
  homepage "https://github.com/nholuongut/tfvars-annotations"

  # Update these when a new version is released
  url "https://github.com/nholuongut/tfvars-annotations/archive/v0.0.3.tar.gz"
  sha256 "d2f2e6afbba4b4901cbb6bb04713fc17769df9f07eb7675449ea011e4ac8cf3e"

  head "https://github.com/nholuongut/tfvars-annotations.git"
  ...
  def install
    ...
    app_path = buildpath/"src/github.com/nholuongut/tfvars-annotations"
    app_path.install Dir["*"]

    # Fetch the deps (into our temporary gopath) and build
    cd "src/github.com/nholuongut/tfvars-annotations" do
      system "go", "get"
